								...
								<table width="452" height="290" border="0" cellpadding="0" cellspacing="0">
									...
									<tr>
										<td align="center" valign="bottom" background="${pageContext.request.contextPath}/images/loginbg.gif">
											...
											<s:form id="loginAction_home" name="form1" action="login.action" target="_parent" method="post">
											<%-- <form id="loginAction_home" name="form1" action="${pageContext.request.contextPath}/login/home.jsp" target="_parent" method="post"> --%>
												<table border="0" align="center" cellpadding="2" cellspacing="0">
													...
													<tr>
														...
														<td>
															<s:textfield name="logonName" value="" id="logonName" cssClass="text" cssStyle="width: 160px;"></s:textfield>
													...
													<tr>
														...
														<td>
															<s:submit name="submit" value="登录" cssClass="buttoninput"></s:submit>
