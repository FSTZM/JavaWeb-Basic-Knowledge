...
<HTML>
	...
	<body>
		<br>
		<s:form id="Form1" name="Form1" action="findUserByCondition.action">
						...
						<td>
							<table cellpadding="0" cellspacing="0" border="0" width="100%">
								<tr>
									...
									<td class="ta_01" bgColor="#ffffff">
										<s:select name="gender" list="{'男','女'}" headerKey="" headerValue="---请选择---"></s:select>
									</td>
								</tr>
								<tr>
									<td height="22" align="center" bgColor="#f5fafe" class="ta_01">
									...
									<td class="ta_01" bgColor="#ffffff">
										<s:select name="education" list="{'研究生','本科','专科','高中','初中','小学'}" headerKey="" headerValue="---请选择---"></s:select>
									</td>
									<td height="22" align="center" bgColor="#f5fafe" class="ta_01">
										是否上传简历
									</td>
									<td class="ta_01" bgColor="#ffffff">
										<s:select name="isUpload" list="#{'true':'有','false':'无'}" headerKey="" headerValue="---请选择---"></s:select>
									</td>
								</tr>
								<tr>
